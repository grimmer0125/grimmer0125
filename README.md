...
9. **Library**: [d4c](https://www.npmjs.com/package/d4c-queue) A TypeScript task queue lib. Support sync/async/promise-returning function, decorators, JavaScript, browser, and Node.js. 100% test coverage. ~ **5,600+ downloads**
...
1. Taiwan PyConTW conference talk: Use Pyodide to run Python in browsers - rendering medical DICOM files [slide](https://slides.com/grimmer/intro_pyodide_medical_dicom_viewer/) 2021.10
2. Taiwan COSCUP conference talk: What is synchronization & concurrency in JavaScript - Use a TypeScript task queue library to introduce. [slide](https://slides.com/grimmer/intro_js_ts_task_queuelib_d4c/fullscreen) & [video](https://drive.google.com/file/d/1jEbW5eyEu5OArnChTcpQ146JVOuDhEBG/view?usp=sharing) 2021.08
